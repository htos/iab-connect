...
Last Updated: 2026-06-01 (Epic-20 retro added A34-A37: Bulk spec-refresh at epic start when implementing multiple stories in one session / Frontend Vitest + Testing Library `afterEach(cleanup)` is mandatory / ASP.NET Core integration tests reading env-var-mapped IConfiguration MUST override in TestWebApplicationFactory / License-related changes must grep README for contradictory prose; A28-A33 from Epic-11 + Epic-12 carry forward)
