        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
          ...
          {canManageEvents && (
            <div className="px-6 py-4 border-t border-gray-100 flex flex-wrap gap-3">
              ...
              <Link href={`/events/${event.id}/fees`} className="inline-flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
