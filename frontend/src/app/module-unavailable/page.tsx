...
/**
 * REQ-087 (E10-S4): shown when a user lands on a disabled-module route — either via the
 * middleware rewrite (direct URL) or by following a stale link/bookmark. UX-only; the
 * backend 403 from E10-S3 is the real control. Renders inside the authenticated shell —
 * MainLayout adds Header + Sidebar for any route that is not under /public or /login.
 */
