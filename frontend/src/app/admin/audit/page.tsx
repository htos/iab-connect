        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl flex items-center gap-2 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-green-500"
            >
              {isExporting ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 mb-6">
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className="px-4 py-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-500 rounded-xl"
              >
                {t("filters.clear")}
              </button>
            </div>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1 border border-gray-300 rounded-xl hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
              >
                {tCommon("previous")}
              </button>
              <button
