...
public sealed class UpdateActivityAreaCommandValidator : AbstractValidator<UpdateActivityAreaCommand>
{
    public UpdateActivityAreaCommandValidator()
    {
        RuleFor(x => x.Id).NotEmpty().WithMessage("Activity area ID is required.");
