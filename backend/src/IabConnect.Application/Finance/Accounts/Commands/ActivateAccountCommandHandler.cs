...
public sealed class ActivateAccountCommandHandler : IRequestHandler<ActivateAccountCommand, AccountDto?>
{
    ...
    public async Task<AccountDto?> Handle(ActivateAccountCommand request, CancellationToken ct)
    {
