...
public sealed class ApproveExpenseClaimCommandHandler : IRequestHandler<ApproveExpenseClaimCommand, ExpenseClaimDto>
{
    ...
    public async Task<ExpenseClaimDto> Handle(ApproveExpenseClaimCommand request, CancellationToken ct)
    {
        ...
        claim.Approve(request.UserName, request.Comment);
        ...
        await _auditService.LogActionAsync(
            ...
            $"Expense claim '{claim.Title}' approved by {request.UserName}",
