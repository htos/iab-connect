...
public sealed class ReviewExpenseClaimCommandHandler : IRequestHandler<ReviewExpenseClaimCommand, ExpenseClaimDto>
{
    private readonly IExpenseClaimRepository _repository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IAuditService _auditService;

    public ReviewExpenseClaimCommandHandler(
    ...
    public async Task<ExpenseClaimDto> Handle(ReviewExpenseClaimCommand request, CancellationToken ct)
    {
        ...
        claim.Review(request.UserName, request.Comment);
        ...
        await _auditService.LogActionAsync(
            ...
            $"Expense claim '{claim.Title}' reviewed by {request.UserName}",
