...
namespace IabConnect.Infrastructure.Migrations
{
    ...
    [Migration("20260607122831_AddWebhookDeliveries")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IabConnect.Domain.Common.ModuleSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("module_settings", (string)null);
                });
            ...
            modelBuilder.Entity("IabConnect.Domain.Events.EventFeeCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_event_fee_categories_event_id");
                    ...
                    b.ToTable("event_fee_categories", null, t =>
                        {
                            t.HasCheckConstraint("ck_event_fee_categories_amount_non_negative", "amount >= 0");
                        });
                });
            ...
            modelBuilder.Entity("IabConnect.Domain.Finance.Budget", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ActivityAreaId", "FiscalPeriodId")
                        .IsUnique()
            ...
            modelBuilder.Entity("IabConnect.Domain.Integration.ApiClient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("IabConnect.Domain.Integration.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("IabConnect.Domain.Integration.WebhookSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("IabConnect.Domain.Members.Member", b =>
                {
                    ...
                    b.Property<string>("CalendarSubscriptionTokenHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.HasIndex("CalendarSubscriptionTokenHash")
                        .IsUnique()
            ...
            modelBuilder.Entity("IabConnect.Domain.Finance.Budget", b =>
                {
                    b.HasOne("IabConnect.Domain.Finance.ActivityArea", null)
                        .WithMany()
                        .HasForeignKey("ActivityAreaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("IabConnect.Domain.Finance.FiscalPeriod", null)
                        .WithMany()
